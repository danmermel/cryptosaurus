...
for(var i in lines) {
  ...
  if (obj.rsi > 70 && obj.usd_price < sell_price && last_action == 'sell') {
  ...
  if ( obj.rsi < 30 && obj.usd_price > buy_price  && last_action == 'buy') {
     dollar_balance += obj.usd_price *  crypto_balance;
    crypto_balance = 0;
    sell_price = obj.usd_price;
    last_action = 'sell';
